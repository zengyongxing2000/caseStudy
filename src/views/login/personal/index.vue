<template>
  <div class="page-personal">
    <Header :tag="tag" />
    <div class="my_there" style="margin-top: 0.27rem">
      <div class="there_wrap">
        <div class="there_item">
          <p class="there_p" style="height: 1.33rem">
            头像
            <span>
              <i
                class="iconfont icon-touxiang11"
        ...
        <div class="there_item">
          <p class="there_p" @click="$router.push('/username')">
            用户名
